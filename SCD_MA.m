...
%         end
    ...
    figure,subplot(141);image(I);axis off, title('Source');
    set(gcf,'units','normalized','outerposition',[0 0 1 1]);
   
   subplot(142),image(H);axis off, title('S1');
    set(gcf,'units','normalized','outerposition',[0 0 1 1]);

   subplot(143),image(E);axis off, title('S2');
    set(gcf,'units','normalized','outerposition',[0 0 1 1]);

    subplot(144),image(Bg);axis off, title('S3');
    set(gcf,'units','normalized','outerposition',[0 0 1 1]);
